...
({
    doInit : function(cmp, event) {
        ...
        // var comp15 = cmp.find("c:CMP15");

        // console.log('CMP1',comp15);
        // cmp.set("v.comp15", comp15);

        // var comp15 = cmp.get("v.comp15");

        // var child = cmp.find("CMP13");
        // child.sampleMethod1(comp15);
        // $A.createComponent(
        //         "c:CMP15",
        //         {
        //             "aura:id" : "CMP15",
        ...
        //                 // body.push(newCard);
        //                 // cmp.set("v.comp15", body);
        //                 cmp.set("v.comp15", newCard);
        //             }
